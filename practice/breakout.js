...
function drawBricks(){
  for (let c = 0; c < brickColumnCount; c++) {
   ...
   ctx.fillRect(brickOffsetLeft + c*(brickWidth + brickPadding), brickOffsetTop + r*(brickHeight + brickPadding), 75, 20);   //this should be a single function call to ctx.fillRect();
    }
  }
}
